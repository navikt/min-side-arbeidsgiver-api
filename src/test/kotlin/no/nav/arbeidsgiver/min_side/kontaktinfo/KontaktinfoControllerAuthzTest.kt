...
//
//@SpringBootTest(classes = [KontaktInfoService::class])
//@MockitoBean(
//    types = [
...
//
//    @Autowired
//    lateinit var kontaktinfoController: KontaktInfoService
//
...
//
//    @Test
//    fun `tilgang til både underenhet og hovedenhet`() = runBlocking {
...
//
//    @Test
//    fun `tilgang til kun underenhet`() = runBlocking {
...
//
//    @Test
//    fun `tilgang til kun hovedenhet`() = runBlocking {
...
//
//    @Test
//    fun `ikke tilgang til hverken hovedenhet eller underenhet `() = runBlocking {
