...
import no.nav.arbeidsgiver.min_side.services.digisyfo.SykmeldingHendelse.SykmeldingsperiodeAGDTO
...
class DigisyfoRepositoryImpl(
    ...
    fun virksomheterOgSykmeldte(nærmestelederFnr: String?, sykmeldingSlutt: LocalDate?): List<Virksomhetsinfo> {
